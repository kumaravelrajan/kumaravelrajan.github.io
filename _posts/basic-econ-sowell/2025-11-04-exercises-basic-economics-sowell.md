...
1. In the Soviet Union the central planners were responsible for estimating supply and demand for millions of products and allocating resources accordingly. This task was too much to take on by a select group of people for the rest of the population. 
...
1. In market economies, companies have to bid resources away from other companies that have alternative uses for the same resource. This forces companies to economize and only order those many resources that are really required. 
...
1. In market economies losses play just an important a role as profits. Losses tell producers that the resources they are using to produce their goods have more valuable uses elsewhere. 
