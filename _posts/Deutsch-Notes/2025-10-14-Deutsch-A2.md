...
1. TABLE PATTERN DIFFERENT FROM der/den/dem only for <ins>artikel</ins>
...
- Regeln
    ...
    - mehr über n-Deklination können Sie [hier](#n-deklination-nomen-im-maskulinum-mit--en-im-plural) finden.
