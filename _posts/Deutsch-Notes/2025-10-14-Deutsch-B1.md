...
Bei **regelmäßiige Verben** sind die Formen des Konjunkitvs II und des Präteritums gleich. 
...
1. Wenn seine Schwester Markus nächste Woche Bescheid geben kännte, wäre das toll. 
...
### When to use wenn, als, wann to denote temportal information?
...
1. Meaning of attributiv
    ...
    In German grammar, "attributiv" in "Komparativ und Superlativ - attributiv" means that the comparative or superlative form of the adjective is used directly before a noun and gets declined (takes adjective endings) according to the gender, case, and number of that noun. The endings an adjektiv takes is detailed [here for bestimmten artikel](https://github.com/kumaravelrajan/deutsch-b1-prep/tree/main/A2#adjektive-nach-dem-bestimmten-artikel) and detailed [here for Unbestimmtenartikel, Negativartikel und Possessivartikel](https://github.com/kumaravelrajan/deutsch-b1-prep/tree/main/A2#adjektive-nach-dem-unbestimmten-artikel-dem-negativartikel-und-dem-possessivartikel)
    ...
    - The form "am höchsten" is the predicative superlative ([detailed in A2](https://github.com/kumaravelrajan/deutsch-b1-prep/tree/main/A2#vergleiche-komparativ-und-superlativ---pr%C3%A4dikativ)) and is typically used after a verb like "sein" (to be), e.g., "Der Berg ist am höchsten" (The mountain is the highest).
...
- All about Passiv
    ...
    - [Passiv Präsens and Passiv Präterium](https://github.com/kumaravelrajan/deutsch-b1-prep/tree/main/A2#aktiv-und-passiv). 
...
- From A2
    ...
    - [Genitiv ergänzungen und Adjektive im Genitiv mit bestimmten und unbestimmten Artikel](https://github.com/kumaravelrajan/deutsch-b1-prep/tree/main/A2#genitiv)
...
1. **"aufgrund dessen"** = deshalb/deswegen/darum/daher: wird hauptsächlich in der Standardsprache und im schriftlichen gebrauch verwendet.
    ...
    z.B. Die Dialekte in Nord- und Süddeutschland sind sehr unterschiedlich, aufgrund dessen/deswegen verstehen sich die Sprechen manchmal nicht. 
...
1. "irgend" kann **vor "Indefinitpronomen"** stehen, z.B. 
    ...
    1. Irgendjemand = Irgendwer (beide deklinierbar)
        1. jemand -> irgendjemand/irgendjemanden/irgendjemandem
            ...
            - Kasus of jemand mentioned in [A2](https://github.com/kumaravelrajan/deutsch-b1-prep/tree/main/A2#jemandniemand-vs-etwasnichts).
...
1. **Nebensätze mit "bevor" und "nachdem"** drüclen aus, dass zwei Geschehen nacheinander stattfinden. 
...
1. "statt" wird auch zusammen mit Präpositionen verwendet.
    ...
    z.B. **Statt im** Mai war die Wahl im Juni. **Statt für** die SPD hat sie für die Grünen gestimmt.
